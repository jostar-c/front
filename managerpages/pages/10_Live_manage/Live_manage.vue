    ...
    <div class="w">
      ...
      <div class="main">
        ...
        <div class="live">
          ...
          <el-button type="text" class="dellive" @click="changeUpdata"
            >更新链接</el-button
          >
        </div>
        ...
        <div id="newlive" v-show="updata == 1">
          ...
          ></el-input>
          <div id="livebutton">
            <el-button round @click="updataLive">确认</el-button>
...
export default {
  ...
  methods: {
    ...
    updataLive() {
      this.oldplatform = this.newplatform;
      this.oldlive = this.newlive;
      this.newlive = "";
      this.newplatform = "";
      this.updata *= -1;
    },
